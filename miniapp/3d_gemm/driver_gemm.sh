...
for large in 0 1
do
    NROWS=1 NCOLS=1 MATRIX_SIZE=4096  BLOCK_SIZE=256 LARGE=${large} sbatch -c 32 -n 1 run_gemm_2d.sh
    ...
    NROWS=4 NCOLS=2 MATRIX_SIZE=4096  BLOCK_SIZE=256 LARGE=${large} sbatch -c 32 -n 8 run_gemm_2d.sh
    ...
    NROWS=8 NCOLS=8 MATRIX_SIZE=4096  BLOCK_SIZE=256 LARGE=${large} sbatch -c 32 -n 64 run_gemm_2d.sh
...
OMP_NUM_THREADS=1 NUM_THREADS=16 MATRIX_SIZE=4096  BLOCK_SIZE=256 sbatch -c 32 -n 1 run_gemm_3d.sh
...
OMP_NUM_THREADS=1 NUM_THREADS=16 MATRIX_SIZE=4096  BLOCK_SIZE=256 sbatch -c 32 -n 8 run_gemm_3d.sh
...
OMP_NUM_THREADS=1 NUM_THREADS=16 MATRIX_SIZE=4096  BLOCK_SIZE=256 sbatch -c 32 -n 64 run_gemm_3d.sh
...
OMP_NUM_THREADS=16 NUM_THREADS=1 MATRIX_SIZE=4096  BLOCK_SIZE=4096  sbatch -c 32 -n 1 run_gemm_3d.sh
...
OMP_NUM_THREADS=16 NUM_THREADS=1 MATRIX_SIZE=4096  BLOCK_SIZE=2048  sbatch -c 32 -n 8 run_gemm_3d.sh
...
OMP_NUM_THREADS=16 NUM_THREADS=1 MATRIX_SIZE=4096  BLOCK_SIZE=1024 sbatch -c 32 -n 64 run_gemm_3d.sh
