...
public:
     ...
     * 
     * \details A taskflow is associated with a Threadpool in which task will be inserted.
     * 
     * \param[in] tp the associated Threadpool
     ...
     * 
     * \details Create and return task associated with index `k` and store its mapped thread and binding value.
     * 
    ...
    /**
     * \brief  Set function `f` to be the binding function, returning werther task `k` should be bound to its thread or not
     * 
